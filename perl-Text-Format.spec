...
Source0:	ftp://ftp.perl.org/pub/CPAN/modules/by-module/Text/Text-Format%{version}.tar.gz
...
(
  cd $RPM_BUILD_ROOT%{perl_sitearch}/auto/Text/Format
...
%{perl_sitearch}/auto/Text/Format
